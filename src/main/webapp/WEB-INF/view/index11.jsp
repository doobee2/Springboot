...
<head>
    ...
    <link rel="stylesheet" href="${path }/resource/css/pure-min.css">
    <link rel="stylesheet" href="${path }/resource/css/grids-responsive-min.css">
    <link rel="stylesheet" href="${path }/resource/css/styles.css">
    <title>메인 페이지</title>
</head>
<body>
    <h1>메인 페이지</h1>
    <c:if test="${empty principal}">
        ...
        <a href="${path}/login" class="pure-button pure-button-primary">로그인</a>
        <a href="${path}/notice/list" class="pure-button pure-button-primary">게시판</a>
    </c:if>

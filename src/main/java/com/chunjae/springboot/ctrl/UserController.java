...
import com.chunjae.springboot.biz.UserService;
import com.chunjae.springboot.entity.User;
import com.chunjae.springboot.excep.NoSuchDataException;
...
public class UserController {
    ...
    @PostMapping("/idCheck")
    @ResponseBody
    public boolean idCheckAjax(@RequestBody User test){
    ...
    public String updateUserPro(User user, Model model){
        User euser = userService.getUserById(user.getId());
        int cnt = 0;
